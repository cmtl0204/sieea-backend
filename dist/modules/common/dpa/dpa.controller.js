...
exports.DpaController = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const catalogue_service_1 = require("../catalogue/catalogue.service");
const dto_1 = require("../catalogue/dto");
const enums_1 = require("../../../shared/enums");
const decorators_1 = require("../../auth/decorators");
let DpaController = class DpaController {
    catalogueService;
...
exports.DpaController = DpaController;
__decorate([
    (0, common_1.Post)(),
...
], DpaController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DpaController.prototype, "catalogue", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DpaController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DpaController.prototype, "findOne", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:returntype", Promise)
], DpaController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DpaController.prototype, "remove", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DpaController.prototype, "removeAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DpaController.prototype, "findCache", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DpaController.prototype, "loadCache", null);
exports.DpaController = DpaController = __decorate([
...
//# sourceMappingURL=dpa.controller.js.map