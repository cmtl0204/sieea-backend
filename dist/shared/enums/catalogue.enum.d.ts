...
export declare enum CatalogueEnrollmentStateEnum {
...
export declare enum CatalogueEnrollmentsAcademicStateEnum {
    APPROVED = "a",
    REPROVED = "r"
}
export declare enum CatalogueSchoolPeriodStateEnum {
    OPEN = "open",
    CLOSE = "close"
}
export declare enum CatalogueSchoolPeriodTypeEnum {
    ORDINARY = "ordinary",
    EXTRAORDINARY = "extraordinary",
    ESPECIAL = "especial"
}
export declare enum CatalogueSubjectRequirementTypeEnum {
    PREREQUISITE = "prerequisite",
    CO_REQUISITE = "co_requisite"
}
export declare enum CatalogueCareersModalityEnum {
    ON_SITE = "on-site",
...
export declare enum CatalogueYesNoEnum {
    YES = "1",
    NO = "2"
}
export declare enum UsersIdentificationTypeStateEnum {
    IDENTIFICATION = "1",
    PASSPORT = "2"
}
export declare enum CatalogueMaritalStatusEnum {
    SINGLE = "single",
    MARRIED = "married",
    WIDOWER = "widower",
    DIVORCED = "divorced",
...
export declare enum CatalogueEthnicOriginEnum {
...
export declare enum CatalogueTypeSchoolEnum {
    FISCAL = "fiscal",
    FISCOMISIONAL = "fiscomisional",
    PARTICULAR = "particular",
    MUNICIPAL = "municipal"
}
export declare enum CatalogueStudentLiveEnum {
    ALONE = "alone",
...
export declare enum CatalogueEconomicContributionEnum {
    PARENTS = "parents",
