...
let VerifyUserMiddleware = class VerifyUserMiddleware {
    ...
    async use(req, res, next) {
        if (req.headers.authorization) {
            ...
            const jwtDecode = this.jwtService.decode(token[1]);
...
exports.VerifyUserMiddleware = VerifyUserMiddleware = __decorate([
